...
5. **Final synthesis step** — The **last step** is always handled by a special Final Executor that writes the human-readable report. Its intent should describe what to synthesize, not what commands to run.
